...
export default function StepperComp() {
  //Controle dos campos
  const [dadosStep2, setDadosStep2] = React.useState({ NomeUsuario: "", Email: "", Senha: "", confirmSenha: "" });
  const [dadosStep3Parc, setDadosStep3Parc] = React.useState({ RazaoSocial: "", NomeFantasia: "", cnpj: "", DataInicioOp: "", ResponsavelEmpresa: "", VolumeOleo: "", Endereco: "", Numero: "", Bairro: "", Cidade: "", uf: "", CidadesAtendem: "", Parceiros: "" });
  const [dadosStep3Estab, setDadosStep3Estab] = React.useState({ RazaoSocial: "", NomeFantasia: "", cnpj: "", DataInicioOp: "", ResponsavelEmpresa: "", VolumeOleo: "", Endereco: "", Numero: "", Bairro: "", Cidade: "", uf: "", Parceiros: "" });
